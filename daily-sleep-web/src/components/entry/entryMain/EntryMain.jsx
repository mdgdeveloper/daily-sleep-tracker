    ...
    <div className="em-main">
      <div className="em-wrapper">
        <div className="em-list">
          ...
          <div className="em-item em-item-blue">
            <div className="em-item-icon">
        ...
        {fecha !== null && (
          <div className="em-pending-list">
            ...
            {entryRating && (
              <div className="em-entry-rating">
                <EntryRating setRated={setRated} setRating={setRating} />
              </div>
            )}

            {rated && (
              <div className="em-entry-close-rating">
                <div className="em-button">
                  <input
                    onClick={handleCloseEntry}
                    type="button"
                    value="Send Rating"
                    className="em-button-send-style"
                  />
                </div>
              </div>
            )}
